...
namespace CS_SQLite3
{
    ...
    public partial class CSSQLite
    {
        ...
        private static void storeTypeInfo(Mem A, int B)
        {
            _storeTypeInfo(A);
        }

        private static void _storeTypeInfo(Mem pMem)
        {
        ...
        private static int[] opcodeProperty = OPFLG_INITIALIZER;

        private static bool sqlite3VdbeOpcodeHasProperty(int opcode, int mask)
        {
            Debug.Assert(opcode > 0 && opcode < opcodeProperty.Length);
        ...
        )
        {
            ...
            if (SQLITE_OK == sqlite3VdbeMemGrow(pMem, nByte, 0))
            {
                ...
                pCx.iDb = iDb;
                pCx.nField = nField;
                if (nField != 0) pCx.aType = new u32[nField]; // (u32*)&pMem.z[sizeof( VdbeCursor )];
                if (isBtreeCursor != 0)
                    pCx.pCursor =
                        new BtCursor(); // (BtCursor*)&pMem.z[sizeof( VdbeCursor ) + 2 * nField * sizeof( u32 )];
            }
        ...
        )
        {
            if (affinity == SQLITE_AFF_TEXT)
            {
                ...
                if ((pRec.flags & (MEM_Blob | MEM_Str)) == (MEM_Blob | MEM_Str))
                {
                    ...
                    for (var i = 0; i < pRec.zBLOB.Length; i++) sb.Append((char)pRec.zBLOB[i]);
                    pRec.z = sb.ToString();
                    pRec.zBLOB = null;
            ...
            else if (affinity != SQLITE_AFF_NONE)
            {
                ...
                if ((pRec.flags & MEM_Real) != 0) sqlite3VdbeIntegerAffinity(pRec);
            }
        }
    ...
    static int checkSavepointCount( sqlite3 db )
    {
      ...
      return 1;
        ...
        )
        {
            ...
            var rc = SQLITE_OK; /* Value to return */
            var db = p.db; /* The database */
            var encoding = ENC(db); /* The database encoding */
            ...
            int opProperty;
            var iCompare = 0; /* Result of last OP_Compare operation */
...
int origPc;                  /* Program counter at start of opcode */
            ...
            var nProgressOps = 0; /* Opcodes executed since progress callback. */
#endif
            ...
            REGISTER_TRACE( p, pOp.p3, pIn3 );
                ...
                switch (pOp.opcode)
                {
                    ...
                    case OP_Halt:
                    {
                        ...
                        if (pOp.p4.z != null) sqlite3SetString(ref p.zErrMsg, db, "%s", pOp.p4.z);
...
pOp->p1 = pOut->n;
              ...
              REGISTER_TRACE( p, pOp.p2, pOut );
                    ...
                    case OP_Concat:
                    {
                        ...
                        if (ExpandBlob(pIn1) != 0 || ExpandBlob(pIn2) != 0)
                            if ((pIn1.flags & (MEM_Str | MEM_Blob)) == 0 &&
                                sqlite3VdbeMemStringify(pIn1, encoding) != 0)
                                // Stringify(pIn1, encoding);
                                if ((pIn2.flags & (MEM_Str | MEM_Blob)) == 0 &&
                        ...
                        if (pIn2.z != null)
                        {
                            pOut.z = pIn2.z.Substring(0, pIn2.n) + pIn1.z.Substring(0, pIn1.n);
                        }
                        else
                        {
              ...
              UPDATE_MAX_BLOBSIZE( pOut );
                        ...
                        else
                        {
                            ...
                            switch (pOp.opcode)
                            {
                                ...
                                case OP_Divide:
                                {
                                    ...
                                    if (rA == 0) goto arithmetic_result_is_null;
                                    rB /= rA;
                                    break;
                                }
                                default:
                            ...
                            if ((flags & MEM_Real) == 0) sqlite3VdbeIntegerAffinity(pOut);
                        }
                ...
                REGISTER_TRACE( p, pOp.p2, pArg );
                        ...
                        {
                            ctx.pVdbeFunc = pOp.p4.pVdbeFunc;
              ...
              if ( sqlite3SafetyOn( db ) ) goto abort_due_to_misuse;
                    ...
                    case OP_MustBeInt:
                    {
                        ...
                        {
                            if (pOp.p2 == 0) rc = SQLITE_MISMATCH;
                    ...
                    {
                        /* in1 */
                        if ((pIn1.flags & MEM_Int) != 0) sqlite3VdbeMemRealify(pIn1);
                        break;
                    }
              ...
              UPDATE_MAX_BLOBSIZE( pIn1 );
                    ...
                    case OP_ToNumeric:
                    {
                        ...
                        if ((pIn1.flags & (MEM_Null | MEM_Int | MEM_Real)) == 0) sqlite3VdbeMemNumerify(pIn1);
                        break;
                    }
                    ...
                    case OP_ToInt:
                    {
                        ...
                        if ((pIn1.flags & MEM_Null) == 0) sqlite3VdbeMemIntegerify(pIn1);
                        break;
                    }
                    ...
                    case OP_ToReal:
                    {
                        ...
                        if ((pIn1.flags & MEM_Null) == 0) sqlite3VdbeMemRealify(pIn1);
                        break;
                    }
#endif // * SQLITE_OMIT_CAST */
                ...
                REGISTER_TRACE( p, pOp.p2, pOut );
                    ...
                    case OP_Or:
                    {
                        ...
                        {
                            byte[] and_logic = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };
                            v1 = and_logic[v1 * 3 + v2];
                        }
                        else
                        {
                            byte[] or_logic = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };
                            v1 = or_logic[v1 * 3 + v2];
                        }
...
c = sqlite3VdbeIntValue(pIn1)!=0;
                    ...
                    case OP_IsNull:
                    {
                        ...
                        if ((pIn1.flags & MEM_Null) != 0) pc = pOp.p2 - 1;
                        break;
                    }
...
break;
                    ...
                    case OP_Column:
                    {
                        ...
                        var nField = 0; /* number of fields in the record */
...
Debug.Assert( pC.pVtabCursor==0 );
                  ...
                  rc = SQLITE_CORRUPT_BKPT();
                            ...
                            if (zRec == null && avail < len)
                            {
                                ...
                                if (rc != SQLITE_OK) goto op_column_out;
                                zData = sMem.zBLOB;
                            }
                            ...
                            if (zIdx > zEndHdr || offset64 > payloadSize
                                               || (zIdx == zEndHdr && offset64 != payloadSize))
                            {
#if SQLITE_DEBUG
                  rc = SQLITE_CORRUPT_BKPT();
#else
              ...
              REGISTER_TRACE( p, pOp.p3, pDest );
                    ...
                    case OP_Affinity:
                    {
                        ...
                        for (var pD0 = pOp.p1; pD0 <= pOp.p1 + pOp.p2 - 1; pD0++)
                        {
                            pRec = p.aMem[pD0];
                            ExpandBlob(pRec);
                            applyAffinity(pRec, zAffinity[pD0 - pOp.p1], encoding);
                        }
                    ...
                    case OP_MakeRecord:
                    {
                         ...
                         */
                        //for (pRec = pData0; pRec <= pLast; pRec++)
                        for (var pD0 = 0; pD0 < nField; pD0++)
                        {
                            pRec = p.aMem[pOp.p1 + pD0];
                            if (pD0 < zAffinity.Length && zAffinity[pD0] != '\0')
                                applyAffinity(pRec, zAffinity[pD0], encoding);
                            if ((pRec.flags & MEM_Zero) != 0 && pRec.n > 0) sqlite3VdbeMemExpandBlob(pRec);
                            ...
                            if ((pRec.flags & MEM_Zero) != 0)
                                ...
                                nZero += pRec.u.nZero;
                            else if (len != 0) nZero = 0;
                        }

                        /* Add the initial header varint and total the size */
                        nHdr += nVarint = sqlite3VarintLen((u64)nHdr);
                        if (nVarint < sqlite3VarintLen((u64)nHdr)) nHdr++;
                        ...
                        for (var pD0 = 0; pD0 < nField; pD0++) //for (pRec = pData0; pRec <= pLast; pRec++)
                        {
                            pRec = p.aMem[pOp.p1 + pD0];
                            serial_type = sqlite3VdbeSerialType(pRec, file_format);
              ...
              UPDATE_MAX_BLOBSIZE( pOut );
                    ...
                    case OP_Savepoint:
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                 ...
                                 ** is committed.
                                 */
                                var isTransaction = pSavepoint.pNext == null && db.isTransactionSavepoint != 0 ? 1 : 0;
                                ...
                                if (p1 == SAVEPOINT_RELEASE)
                                {
                                    ...
                                    if (0 == isTransaction) db.nSavepoint--;
                                }
                            }
                        }
                    ...
                    case OP_VerifyCookie:
                    {
                        ...
                        if (iMeta != pOp.p2)
                        {
                             ...
                             ** a v-table method.
                             */
                            if (db.aDb[pOp.p1].pSchema.schema_cookie != iMeta) sqlite3ResetInternalSchema(db, pOp.p1);
                  ...
                  rc = SQLITE_CORRUPT_BKPT();
                    ...
                    case OP_OpenEphemeral:
                    {
                        ...
                        rc = sqlite3BtreeFactory(db, null, true, SQLITE_DEFAULT_TEMP_CACHE_SIZE, openFlags,
                            ref pCx.pBt);
                        if (rc == SQLITE_OK) rc = sqlite3BtreeBeginTrans(pCx.pBt, 1);
                        if (rc == SQLITE_OK)
                        {
                        ...
                        if (pC.pCursor != null)
                        {
                            ...
                            if (pC.isTable)
                            {
                                ...
                                if ((pIn3.flags & MEM_Int) == 0)
                                {
                                    ...
                                    if (iKey == SMALLEST_INT64 && (pIn3.r < iKey || pIn3.r > 0))
                                    {
                            ...
                            else
                            {
                                ...
                                for (var rI = 0; rI < r.nField; rI++)
                                    r.aMem[rI] = p.aMem[pOp.p3 + rI]; // r.aMem = p.aMem[pOp.p3];
                ...
                sqlite3_search_count.iValue++;
                    ...
                    case OP_NotExists:
                    {
                        ...
                        if (pCrsr != null)
                        {
                            res = 0;
                            iKey = pIn3.u.i;
                            rc = sqlite3BtreeMovetoUnpacked(pCrsr, null, iKey, 0, ref res);
...
const int MAX_ROWID = i32.MaxValue;//#   define MAX_ROWID 0x7fffffff
                    ...
                    REGISTER_TRACE( p, pOp.p3, pMem );
                                    ...
                                    if (pMem.u.i == MAX_ROWID || pC.useRandomRowid) rc = SQLITE_FULL;

                                    if (v < pMem.u.i + 1) v = (int)(pMem.u.i + 1);
                                    pMem.u.i = v;
                                }
#endif
                            ...
                            if (pC.useRandomRowid)
                            {
                                ...
                                if (rc == SQLITE_OK && res == 0) rc = SQLITE_FULL;
                            }
              ...
              REGISTER_TRACE( p, pOp.p3, pKey );
                        ...
                        if (pC.pseudoTable)
                        {
                            ...
                            else
                            {
                                ...
                                if (pC.pData == null)
                                    if (pC.nData > 0)
                                        Buffer.BlockCopy(pData.zBLOB, 0, pC.pData, 0,
                                            pC.nData); // memcpy(pC.pData, pData.z, pC.nData);
                                //pC.pData[pC.nData] = 0;
                    ...
                    case OP_ResetCount:
                    {
                        if (pOp.p1 != 0) sqlite3VdbeSetChanges(db, p.nChange);
                        p.nChange = 0;
                        break;
                    }
                    ...
                    case OP_RowData:
                    {
                        ...
                        else
                        {
                            ...
                            rc = sqlite3BtreeData(pCrsr, 0, n, pOut.zBLOB);
                        }
...
if( sqlite3SafetyOn(db) ) goto abort_due_to_misuse;
                    ...
                    case OP_NullRow:
                    {
                        ...
                        pC.nullRow = true;
                        pC.rowidIsValid = false;
                        if (pC.pCursor != null) sqlite3BtreeClearCursor(pC.pCursor);
                        break;
                    }
              ...
              sqlite3_search_count.iValue--;
                    ...
                    case OP_Next:
                    {
                        ...
                        Debug.Assert(pOp.p1 >= 0 && pOp.p1 < p.nCursor);
                        pC = p.apCsr[pOp.p1];
                        if (pC == null) break; /* See ticket #2273 */
                        pCrsr = pC.pCursor;
                        if (pCrsr == null)
                        {
                            pC.nullRow = true;
                    ...
                    case OP_IdxDelete:
                    {
                        ...
                        if (ALWAYS(pCrsr != null))
                        {
                            ...
                            r.flags = 0;
                            r.aMem = new Mem[r.nField];
                            for (var ra = 0; ra < r.nField; ra++) r.aMem[ra] = p.aMem[pOp.p2 + ra];
                            rc = sqlite3BtreeMovetoUnpacked(pCrsr, r, 0, 0, ref res);
                            if (rc == SQLITE_OK && res == 0) rc = sqlite3BtreeDelete(pCrsr);
                            Debug.Assert(!pC.deferredMoveto);
                            pC.cacheStatus = CACHE_STALE;
                        }
...
iCnt++;
                    ...
                    case OP_Clear:
                    {
                        ...
                        {
                            p.nChange += nChange;
                            if (pOp.p3 > 0) p.aMem[pOp.p3].u.i += nChange;
                        }
                  ...
                  sqlite3SafetyOn( db );
                    ...
                    case OP_IntegrityCk:
                    {
                        ...
                        int j; /* Loop counter */
                        var nErr = 0; /* Number of errors reported */
              ...
              UPDATE_MAX_BLOBSIZE( pIn1 );
                    ...
                    case OP_AggFinal:
                    {
                        ...
                        p.aMem[pOp.p1] = pMem;
                        if (rc != 0) sqlite3SetString(ref p.zErrMsg, db, sqlite3_value_text(pMem));

namespace CS_SQLite3
{
    public partial class CSSQLite
    {
         ...
         ** pager.h.
         */
        private const int BTREE_OMIT_JOURNAL = 1; /* Do not use journal.  No argument */
        private const int BTREE_NO_READLOCK = 2; /* Omit readlocks on readonly files */
        private const int BTREE_MEMORY = 4; /* In-memory DB.  No argument */
        private const int BTREE_READONLY = 8; /* Open the database in read-only mode */
        private const int BTREE_READWRITE = 16; /* Open for both reading and writing */
        private const int BTREE_CREATE = 32; /* Create the database if it does not exist */
         ...
         */
        private const int BTREE_INTKEY = 1; /* Table has only 64-bit signed integer keys */
        private const int BTREE_ZERODATA = 2; /* Table has keys only - no data */
        private const int BTREE_LEAFDATA = 4; /* Data stored in leaves only.  Implies INTKEY */

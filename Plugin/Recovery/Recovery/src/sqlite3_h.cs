...
namespace CS_SQLite3
{
    public partial class CSSQLite
    {
        ...
        private const string SQLITE_VERSION = "3.6.17.C#";
        private const int SQLITE_VERSION_NUMBER = 300601767;
        ...
        private const int SQLITE_CONFIG_SINGLETHREAD = 1; /* nil */

        private const int SQLITE_CONFIG_MULTITHREAD = 2; /* nil */
        private const int SQLITE_CONFIG_SERIALIZED = 3; /* nil */
        private const int SQLITE_CONFIG_MALLOC = 4; /* sqlite3_mem_methods* */
        private const int SQLITE_CONFIG_GETMALLOC = 5; /* sqlite3_mem_methods* */
        private const int SQLITE_CONFIG_SCRATCH = 6; /* void*, int sz, int N */
        private const int SQLITE_CONFIG_PAGECACHE = 7; /* void*, int sz, int N */
        private const int SQLITE_CONFIG_HEAP = 8; /* void*, int nByte, int min */
        private const int SQLITE_CONFIG_MEMSTATUS = 9; /* boolean */
        private const int SQLITE_CONFIG_MUTEX = 10; /* sqlite3_mutex_methods* */
        private const int SQLITE_CONFIG_GETMUTEX = 11; /* sqlite3_mutex_methods* */
        private const int SQLITE_CONFIG_LOOKASIDE = 13; /* int int */
        private const int SQLITE_CONFIG_PCACHE = 14; /* sqlite3_pcache_methods* */
        private const int SQLITE_CONFIG_GETPCACHE = 15; /* sqlite3_pcache_methods* */
        ...
        private const int SQLITE_DBCONFIG_LOOKASIDE = 1001; /* void* int int */
...
//SQLITE_API SQLITE_DEPRECATED int sqlite3_memory_alarm(void(*)(void*,sqlite3_int64,int),void*,sqlite3_int64);
        ...
        {
            private sqlite3_vtab pVtab; /* Virtual table of this cursor */
            /* Virtual table implementations will typically add additional fields */
        }

...
namespace CS_SQLite3
{
    ...
    public partial class CSSQLite
    {
        ...
        */
        ...
        //sqlite3_module
        public delegate int smdxCreate(sqlite3 db, object pAux, int argc, string constargv, ref sqlite3_vtab ppVTab,
            ref string pError);

        public delegate int smdxConnect(sqlite3 db, object pAux, int argc, string constargv, ref sqlite3_vtab ppVTab,
            ref string pError);
        ...
        public delegate int smdxFindFunction(sqlite3_vtab pVtab, int nArg, string zName, object pxFunc,
            ref sqlite3_value[] ppArg);

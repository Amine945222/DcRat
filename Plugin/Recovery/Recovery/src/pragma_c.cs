...
namespace CS_SQLite3
{
    public partial class CSSQLite
    {
        ...
        */
        ...
        {
            //                             /* 123456789 123456789 */
            var zText = "onoffalseyestruefull";
            int[] iOffset = { 0, 1, 2, 4, 9, 12, 16 };
            int[] iLength = { 2, 2, 3, 5, 3, 4, 4 };
            u8[] iValue = { 1, 0, 0, 0, 1, 1, 2 };
            int i, n;
            if (sqlite3Isdigit(z[0])) return (u8)atoi(z);
            n = sqlite3Strlen30(z);
         ...
         */
        private static u8 getBoolean(string z)
        {
        ...
        private static int getTempStore(string z)
        {
            if (z[0] >= '0' && z[0] <= '2')
                return z[0] - '0';
            if (sqlite3StrICmp(z, "file") == 0)
                return 1;
            if (sqlite3StrICmp(z, "memory") == 0)
                return 2;
            return 0;
        }
        ...
        {
            var ts = getTempStore(zStorageType);
            var db = pParse.db;
 ...
 ** flag if there are any active statements. */
        ...
        )
        {
            ...
            var db = pParse.db;
            Db pDb;
            var v = pParse.pVdbe = sqlite3VdbeCreate(db);
            if (v == null) return;
            pParse.nMem = 2;
             ...
             */
            if (iDb == 1 && sqlite3OpenTempDatabase(pParse) != 0) return;
...
goto pragma_out;
            ...
            if (sqlite3StrICmp(zLeft, "page_size") == 0)
            {
                ...
                if (null == zRight)
                {
                    var size = ALWAYS(pBt) ? sqlite3BtreeGetPageSize(pBt) : 0;
            ...
            if (sqlite3StrICmp(zLeft, "max_page_count") == 0)
            {
                ...
                var newMax = 0;
                Debug.Assert(pBt != null);
                if (zRight != null) newMax = atoi(zRight);
                if (ALWAYS(pBt)) newMax = sqlite3BtreeMaxPageCount(pBt, newMax);
            ...
            if (zLeft == "journal_mode")
            {
                ...
                {
                    var n = sqlite3Strlen30(zRight);
                    eMode = azModeName.Length - 1; //sizeof(azModeName)/sizeof(azModeName[0]) - 1;
                    while (eMode >= 0 && string.Compare(zRight, azModeName[eMode], true) != 0) eMode--;
                }
            ...
            {
                var pPager = sqlite3BtreePager(pDb.pBt);
                i64 iLimit = -2;
            ...
            if (sqlite3StrICmp(zLeft, "auto_vacuum") == 0)
            {
                ...
                else
                {
                    ...
                    if (ALWAYS(eAuto >= 0))
                    {
                         ...
                         */
                        var rc = sqlite3BtreeSetAutoVacuum(pBt, eAuto);
            ...
            if (sqlite3StrICmp(zLeft, "incremental_vacuum") == 0)
            {
                int iLimit = 0, addr;
                if (sqlite3ReadSchema(pParse) != 0) goto pragma_out;
                if (zRight == null || !sqlite3GetInt32(zRight, ref iLimit) || iLimit <= 0) iLimit = 0x7fffffff;
                sqlite3BeginWriteOperation(pParse, 0, iDb);
...
goto pragma_out;
            ...
            else if (sqlite3StrICmp(zLeft, "index_info") == 0 && zRight != null)
            {
                Index pIdx;
                Table pTab;
                if (sqlite3ReadSchema(pParse) != 0) goto pragma_out;
            ...
            else if (sqlite3StrICmp(zLeft, "index_list") == 0 && zRight != null)
            {
                Index pIdx;
                Table pTab;
                if (sqlite3ReadSchema(pParse) != 0) goto pragma_out;
            ...
            else if (sqlite3StrICmp(zLeft, "database_list") == 0)
            {
                int i;
                if (sqlite3ReadSchema(pParse) != 0) goto pragma_out;
                sqlite3VdbeSetNumCols(v, 3);
            ...
            else if (sqlite3StrICmp(zLeft, "collation_list") == 0)
            {
                var i = 0;
                HashElem p;
                ...
                for (p = db.aCollSeq.first;
                     p != null;
                     p = p.next) //( p = sqliteHashFirst( db.aCollSeq ) ; p; p = sqliteHashNext( p ) )
                {
                    var pColl = ((CollSeq[])p.data)[0]; // sqliteHashData( p );
                    sqlite3VdbeAddOp2(v, OP_Integer, i++, 1);
                ...
                if (pTab != null)
                {
                    ...
                    if (pFK != null)
                    {
                        ...
                        while (pFK != null)
                        {
                            ...
                            {
                                var zCol = pFK.aCol[j].zCol;
                                var zOnUpdate = actionName(pFK.updateConf);
                                var zOnDelete = actionName(pFK.deleteConf);
                                sqlite3VdbeAddOp2(v, OP_Integer, i, 1);
            ...
            {
                if (zRight != null) sqlite3RegisterLikeFunctions(db, getBoolean(zRight));
            }
            else
               ...
               )
            {
                ...
                for (i = 0; i < db.nDb; i++)
                {
                    ...
                    for (x = pTbls.first; x != null; x = x.next)
                    {
                        ...
                        var pTab = (Table)x.data; // sqliteHashData( x );
                        Index pIdx;
                    ...
                    if (pParse.nMem < cnt + 4) pParse.nMem = cnt + 4;
...
sqlite3ErrorMsg( pParse, "unsupported encoding: %s", zRight );
               ...
               )
            {
                ...
                if (zRight != null && iCookie != BTREE_FREE_PAGE_COUNT)
                {
                    ...
                    var addr = sqlite3VdbeAddOpList(v, ArraySize(setCookie), setCookie);
                    sqlite3VdbeChangeP1(v, addr, iDb);
                ...
                else
                {
                    ...
                    var addr = sqlite3VdbeAddOpList(v, readCookie.Length,

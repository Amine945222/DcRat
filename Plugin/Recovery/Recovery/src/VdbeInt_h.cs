...
set { _flags = value; }
        ...
        private const int MEM_Null = 0x0001; /* Value is NULL */
        private const int MEM_Str = 0x0002; /* Value is a string */
        private const int MEM_Int = 0x0004; /* Value is an integer */
        private const int MEM_Real = 0x0008; /* Value is a real number */
        private const int MEM_Blob = 0x0010; /* Value is a BLOB */
        private const int MEM_RowSet = 0x0020; /* Value is a RowSet object */
        private const int MEM_TypeMask = 0x00ff; /* Mask of type bits */

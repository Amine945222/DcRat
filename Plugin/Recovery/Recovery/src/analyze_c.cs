...
namespace CS_SQLite3
{
    ...
    public partial class CSSQLite
    {
        ...
        )
        {
             ...
             */
            if (createStat1 == 0) sqlite3TableLock(pParse, iDb, iRootPage, 1, "sqlite_stat1");
...
return;
        ...
        VdbeComment( v, "%s", pIdx.zName );
                ...
                regRec = regCol + 1;
                if (regRec > pParse.nMem) pParse.nMem = regRec;
                 ...
                 */
                for (i = 0; i <= nCol; i++) sqlite3VdbeAddOp2(v, OP_Integer, 0, iMem + i);
                for (i = 0; i < nCol; i++) sqlite3VdbeAddOp2(v, OP_Null, 0, iMem + nCol + i + 1);
                ...
                */
                ...
                sqlite3VdbeAddOp4(v, OP_MakeRecord, regFields, 3, regRec, new[] { (byte)'a', (byte)'a', (byte)'a' }, 0);
        ...
        {
            var v = sqlite3GetVdbe(pParse);
            if (v != null) sqlite3VdbeAddOp1(v, OP_LoadAnalysis, iDb);
        }
        ...
        {
            var db = pParse.db;
            var pSchema = db.aDb[iDb].pSchema; /* Schema of database iDb */
            HashElem k;
            int iStatCur;
            int iMem;
            ...
            {
                var pTab = (Table)k.data; // sqliteHashData( k );
         ...
         ** a database.
         */
        private static void analyzeTable(Parse pParse, Table pTab)
        {
            int iDb;
            int iStatCur;
            ...
            else if (pName2.n == 0)
            {
                ...
                else
                {
                    ...
                    if (z != null)
                    {
                        ...
                        if (pTab != null) analyzeTable(pParse, pTab);
                    }
                }
            }
            else
        ...
        {
            var argv = (string[])Oargv;
            var pInfo = (analysisInfo)pData;
            Index pIndex;
            int i, c;
            int v;
            string z;
            ...
            if (argv == null || argv[0] == null || argv[1] == null) return 0;
        ...
        private static int sqlite3AnalysisLoad(sqlite3 db, int iDb)
        {
            ...
            {
                var pIdx = (Index)i.data; // sqliteHashData( i );
            ...
            if (sqlite3FindTable(db, "sqlite_stat1", sInfo.zDatabase) == null) return SQLITE_ERROR;

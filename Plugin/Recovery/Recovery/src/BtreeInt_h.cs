        ...
        public class MemPage
        {
            ...
            public MemPage Copy()
            {
                ...
                if (aOvfl != null)
                {
                    ...
                    for (var i = 0; i < aOvfl.Length; i++) cp.aOvfl[i] = aOvfl[i].Copy();
                }
...
public u8 isPending;            /* If waiting for read-locks to clear */
        ...
        public struct CellInfo
        {
            ...
            {
                if (ci.pCell[ci.iCell] != pCell[iCell]) return false;
                if (ci.nKey != nKey || ci.nData != nData || ci.nPayload != nPayload) return false;

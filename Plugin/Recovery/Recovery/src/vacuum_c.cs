...
namespace CS_SQLite3
{
    ...
    public partial class CSSQLite
    {
         ...
         */
        private static int execSql(sqlite3 db, string zSql)
        {
      ...
      //VVA_ONLY( int rc; )
            ...
            string Dummy = null;
            if (SQLITE_OK != sqlite3_prepare(db, zSql, -1, ref pStmt, ref Dummy)) return sqlite3_errcode(db);
#if !NDEBUG
      ...
      Debug.Assert( rc != SQLITE_ROW );
         ...
         */
        private static int execExecSql(sqlite3 db, string zSql)
        {
            sqlite3_stmt pStmt = null;
            int rc;
        ...
        private static void sqlite3Vacuum(Parse pParse)
        {
            ...
            if (v != null) sqlite3VdbeAddOp2(v, OP_Vacuum, 0, 0);
        }
        ...
        {
            var rc = SQLITE_OK; /* Return code from service routines */
            Btree pMain; /* The database being vacuumed */
            Btree pTemp; /* The temporary database we vacuum into */
            var zSql = ""; /* SQL statements */

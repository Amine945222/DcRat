...
//# define SQLITE_TEMPNAME_SIZE 200
         ...
         **
         */
        private static int PENDING_BYTE = 0x40000000; //sqlite3PendingByte;

        private static readonly int RESERVED_BYTE = PENDING_BYTE + 1;
        private static readonly int SHARED_FIRST = PENDING_BYTE + 2;
        private static readonly int SHARED_SIZE = 510;

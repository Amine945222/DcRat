namespace CS_SQLite3
{
    public partial class CSSQLite
    {
         ...
         ** lower-case character.
         */
        private static readonly int[] sqlite3UpperToLower =
        {
#if SQLITE_ASCII
...
239,240,241,242,243,244,245,246,247,248,249,219,220,221,222,255, /* Fx */
         ...
         */
#if SQLITE_ASCII
        private static readonly byte[] sqlite3CtypeMap =
        {
         ...
         ** the SQLite library.
         */
        private static readonly Sqlite3Config sqlite3Config = new Sqlite3Config(

namespace CS_SQLite3
{
    public partial class CSSQLite
    {
         ...
         */
        private static readonly byte[] sqlite3Utf8Trans1 =
        {
        ...
        //  }
        private static int sqlite3Utf8Read(
        ...
        )
        {
            ...
            if (c >= 0xc0)
            {
                ...
                {
                    c = sqlite3Utf8Trans1[c - 0xc0];
                    while (zIndex != zIn.Length && (zIn[zIndex] & 0xc0) == 0x80) c = (c << 6) + (0x3f & zIn[zIndex++]);
                    if (c < 0x80
                        || (c & 0xFFFFF800) == 0xD800
                        || (c & 0xFFFFFFFE) == 0xFFFE)
                        c = 0xFFFD;
...
return rc;
        ...
        private static int sqlite3Utf8CharLen(string zIn, int nByte)
        {
            ...
            var zInLength = zIn.Length;
            var zTerm = nByte >= 0 && nByte <= zInLength ? nByte : zInLength;

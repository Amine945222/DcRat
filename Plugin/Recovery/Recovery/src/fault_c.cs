namespace CS_SQLite3
{
    public partial class CSSQLite
    {
        ...
        private static readonly BenignMallocHooks sqlite3Hooks = new BenignMallocHooks(null, null);
...
//# define wsdHooks x[0]
        ...
        {
            wsdHooksInit();
            if (wsdHooks.xBenignBegin != null) wsdHooks.xBenignBegin();
        }

        private static void sqlite3EndBenignMalloc()
        {
            wsdHooksInit();
            if (wsdHooks.xBenignEnd != null) wsdHooks.xBenignEnd();
        }

...
namespace CS_SQLite3
{
    ...
    public partial class CSSQLite
    {
        ...
        {
            u8 c;
            return ((c = C) & 0x80) != 0 || (c > 0x1f && sqlite3IsAsciiIdChar[c - 0x20]);
        }
#endif
#if SQLITE_EBCDIC
...
//#define IdChar(C)  (((c=C)>=0x42 && sqlite3IsEbcdicIdChar[c-0x40]))
        ...
        {
            var state = 0; /* Current state, using numbers defined in header comment */
                ...
                switch (zSql[zIdx])
                {
                    ...
                    case '/':
                    {
                        ...
                        while ((zIdx < zSql.Length && zSql[zIdx] != '*') ||
                               (zIdx < zSql.Length - 1 && zSql[zIdx + 1] != '/')) zIdx++;

...
namespace CS_SQLite3
{
    ...
    public partial class CSSQLite
    {
        ...
        private static void sqlite3RowSetClear(RowSet p)
        {
            ...
            for (pChunk = p.pChunk; pChunk != null; pChunk = pNextChunk) pNextChunk = pChunk.pNextChunk;
        ...
        private static void sqlite3RowSetInsert(RowSet p, i64 rowid)
        {
            ...
            if (pLast != null)
            {
                if (p.isSorted && rowid <= pLast.v) p.isSorted = false;
                pLast.pRight = pEntry;
            }
            else
            {
        ...
        private static int sqlite3RowSetNext(RowSet p, ref i64 pRowid)
        {
            ...
            if (p.pEntry != null)
            {
                ...
                if (p.pEntry == null) sqlite3RowSetClear(p);
                return 1;
            }

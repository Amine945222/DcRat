...
//# define SQLITE_THREADSAFE THREADSAFE
        ...
        private const int SQLITE_THREADSAFE = 1;
#endif
#else
const int SQLITE_THREADSAFE = 1;
        ...
        private const int SQLITE_DEFAULT_MEMSTATUS = 1;
#endif
...
//#define OMIT_TEMPDB 1
#else
        private static readonly int OMIT_TEMPDB = 0;
#endif
         ...
         ** work.
         */
        private const int NULL_DISTINCT_FOR_UNIQUE = 1;
        ...
        private static readonly int SQLITE_DEFAULT_FILE_FORMAT = 1; //# define SQLITE_DEFAULT_FILE_FORMAT 1
#endif
        ...
        private static readonly int SQLITE_TEMP_STORE = 1; //#define SQLITE_TEMP_STORE 1
#endif
...
#else
        private static readonly u8 SQLITE_BIGENDIAN = 0; //#define SQLITE_BIGENDIAN    (*(char *)(&sqlite3one)==0)
...
public   sqlite3 db;                    /* "Owner" connection. See comment above */
        ...
        private const int SQLITE_N_LIMIT = SQLITE_LIMIT_VARIABLE_NUMBER + 1;
        ...
        public class sqlite3
        {
            ...
            {
                public u8 busy; /* TRUE if currently initializing */ /* Information used during initialization */
...
public object pAuthArg;               /* 1st argument to the access auth function */
      ...
      public VTable pDisconnect;            /* Disconnect these in next sqlite3_prepare() */
            ...
            public Db[] aDbStatic = { new Db(), new Db() }; /* Static space for the 2 default backends */
...
sqlite3 *pNextBlocked;        /* Next in list of all blocked connections */
        ...
        private const int
            SQLITE_VdbeTrace =
                0x00000001; //#define SQLITE_VdbeTrace      0x00000001  /* True to trace VDBE execution */

        private const int
            SQLITE_InTrans = 0x00000008; //#define SQLITE_InTrans        0x00000008  /* True if in a transaction */

        private const int
            SQLITE_InternChanges =
                0x00000010; //#define SQLITE_InternChanges  0x00000010  /* Uncommitted Hash table changes */

        private const int
            SQLITE_FullColNames =
                0x00000020; //#define SQLITE_FullColNames   0x00000020  /* Show full column names on SELECT */

        private const int
            SQLITE_ShortColNames =
                0x00000040; //#define SQLITE_ShortColNames  0x00000040  /* Show short columns names */

        private const int
            SQLITE_CountRows =
                0x00000080; //#define SQLITE_CountRows      0x00000080  /* Count rows changed by INSERT, */

        //                                          /*   DELETE, or UPDATE and return */
        //                                          /*   the count using a callback. */
        private const int
            SQLITE_NullCallback =
                0x00000100; //#define SQLITE_NullCallback   0x00000100  /* Invoke the callback once if the */

        //                                          /*   result set is empty */
        private const int
            SQLITE_SqlTrace =
                0x00000200; //#define SQLITE_SqlTrace       0x00000200  /* Debug print SQL as it executes */

        private const int
            SQLITE_VdbeListing =
                0x00000400; //#define SQLITE_VdbeListing    0x00000400  /* Debug listings of VDBE programs */

        private const int
            SQLITE_WriteSchema =
                0x00000800; //#define SQLITE_WriteSchema    0x00000800  /* OK to update SQLITE_MASTER */

        private const int
            SQLITE_NoReadlock = 0x00001000; //#define SQLITE_NoReadlock     0x00001000  /* Readlocks are omitted when

        //                                          ** accessing read-only databases */
        private const int
            SQLITE_IgnoreChecks =
                0x00002000; //#define SQLITE_IgnoreChecks   0x00002000  /* Do not enforce check constraints */

        private const int
            SQLITE_ReadUncommitted = 0x00004000; //#define SQLITE_ReadUncommitted 0x00004000 /* For shared-cache mode */

        private const int
            SQLITE_LegacyFileFmt =
                0x00008000; //#define SQLITE_LegacyFileFmt  0x00008000  /* Create new databases in format 1 */

        private const int
            SQLITE_FullFSync =
                0x00010000; //#define SQLITE_FullFSync      0x00010000  /* Use full fsync on the backend */

        private const int
            SQLITE_LoadExtension = 0x00020000; //#define SQLITE_LoadExtension  0x00020000  /* Enable load_extension */

        private const int
            SQLITE_RecoveryMode = 0x00040000; //#define SQLITE_RecoveryMode   0x00040000  /* Ignore schema errors */

        private const int
            SQLITE_ReverseOrder =
                0x00100000; //#define SQLITE_ReverseOrder   0x00100000  /* Reverse unordered SELECTs */
         ...
         */
        private const int
            SQLITE_MAGIC_OPEN = 0x1029a697; //#define SQLITE_MAGIC_OPEN     0xa029a697  /* Database is open */

        private const int
            SQLITE_MAGIC_CLOSED = 0x2f3c2d33; //#define SQLITE_MAGIC_CLOSED   0x9f3c2d33  /* Database is closed */
...
public   u8 isHidden;     /* True if this column is 'hidden' */
         ...
         */
        private const int
            SQLITE_COLL_BINARY = 1; //#define SQLITE_COLL_BINARY  1  /* The default memcmp() collating sequence */

        private const int
            SQLITE_COLL_NOCASE = 2; //#define SQLITE_COLL_NOCASE  2  /* The built-in NOCASE collating sequence */

        private const int
            SQLITE_COLL_REVERSE = 3; //#define SQLITE_COLL_REVERSE 3  /* The built-in REVERSE collating sequence */

        private const int
            SQLITE_COLL_USER = 0; //#define SQLITE_COLL_USER    0  /* Any other user-defined collating sequence */
         ...
         */
        private const int
            SQLITE_JUMPIFNULL = 0x08; //#define SQLITE_JUMPIFNULL   0x08  /* jumps if either operand is NULL */
...
static bool IsVirtual( Column X) { return X.isHidden!=0;}
        ...
        private static bool IsVirtual(Table T)
        {
            return false;
        }

        //#  define IsHiddenColumn(X) 0
        private static bool IsHiddenColumn(Column C)
        {
            return false;
        }
#endif
        ...
        private const int
            OE_Rollback = 1; //#define OE_Rollback 1   /* Fail the operation and rollback the transaction */
        ...
        private const int
            OE_Ignore = 4; //#define OE_Ignore   4   /* Ignore the error. Do not do the INSERT or UPDATE */

        private const int
            OE_Replace = 5; //#define OE_Replace  5   /* Delete existing record, then do INSERT or UPDATE */

        private const int
            OE_Restrict = 6; //#define OE_Restrict 6   /* OE_Abort for IMMEDIATE, OE_Rollback for DEFERRED */
...
set { _n = value; }
            ...
            public Token Copy()
            {
                ...
                if (z == null || z.Length == 0)
                    cp.n = 0;
                else if (n > z.Length) cp.n = z.Length;
                return cp;
            }
        }
        ...
        public class AggInfo_col
        {
            ...
            public Expr pExpr; /* The original expression */ /* For each column used in source tables */
        ...
        public class AggInfo_func
        {
            ...
            public int iMem; /* Memory location that acts as accumulator */ /* For each aggregate function */
        ...
        public class AggInfo
        {
            ...
            public AggInfo Copy()
            {
                ...
                var cp = (AggInfo)MemberwiseClone();
...
set { _op = value; }
        ...
        private const ushort EP_AnyAff = 0x0200;
        private const ushort EP_FixedDest = 0x0400;
        private const ushort EP_IntValue = 0x0800;
        private const ushort EP_xIsSelect = 0x1000;

        private const ushort EP_Reduced = 0x2000;
        private const ushort EP_TokenOnly = 0x4000;
        private const ushort EP_Static = 0x8000;
        ...
        private const ushort EP2_MallocedToken = 0x0001;
        private const ushort EP2_Irreducible = 0x0002;
...
//# define ExprSetIrreducible(X)
        ...
        private const int EXPR_REDUCEDSIZE = 8216;
        private const int EXPR_TOKENONLYSIZE = 16392;
        ...
        private const int BMS = sizeof(Bitmask) * 8;
        ...
        {
            public WhereLevel[] a = { new WhereLevel() }; /* Information about each nest loop in the WHERE */
        ...
        private const int
            SRT_Table = 8; //#define SRT_Table        8  /* Store result as data with an automatic rowid */

        private const int
            SRT_EphemTab = 9; //#define SRT_EphemTab  9  /* Create transient tab and store like SRT_Table /
...
public Table[] apVtabLock;        /* Pointer to virtual tables needing locking */
            ...
            public Parse()
            {
                for (var i = 0; i < aColCache.Length; i++) aColCache[i] = new yColCache();
            }
...
#if SQLITE_OMIT_VIRTUALTABLE
        private static readonly bool IN_DECLARE_VTAB = false; //#define IN_DECLARE_VTAB 0
#else
//  int ;//#define IN_DECLARE_VTAB (pParse.declareVtab)
      ...
      the <column-list> is stored here */
            ...
            public Trigger Copy()
            {
                ...
                var cp = (Trigger)MemberwiseClone();
        ...
        public class TriggerStep
        {
            ...
            public TriggerStep Copy()
            {
                ...
                var cp = (TriggerStep)MemberwiseClone();
                return cp;
            }
        }
...
//#define SQLITE_CORRUPT_BKPT SQLITE_CORRUPT
        private const int SQLITE_CORRUPT_BKPT = SQLITE_CORRUPT;
#endif
...
//void sqlite3TableLock(Parse *, int, int, u8, const char *);
    ...
    ///int sqlite3Utf8To8(unsigned char*);
        ...
        private static void sqlite3VtabBeginParse(Parse p, Token t1, Token t2, Token t3)
        {
